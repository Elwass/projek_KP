                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('nim') is-invalid @enderror" id="nim" name="nim" value="{{ old('nim', $pendaftar->nim) }}">
                            @error('nim')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('univ') is-invalid @enderror" id="univ" name="univ" value="{{ old('univ', $pendaftar->universitas) }}">
                            @error('univ')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="date" class="form-control @error('tgl_mulai') is-invalid @enderror" id="tgl_mulai" name="tgl_mulai" value="{{ old('tgl_mulai', $pendaftar->tgl_mulai) }}">
                            @error('tgl_mulai')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="date" class="form-control @error('tgl_selesai') is-invalid @enderror" id="tgl_selesai" name="tgl_selesai" value="{{ old('tgl_selesai', $pendaftar->tgl_selesai) }}">
                            @error('tgl_selesai')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <div class="custom-file">
                                ...
                                @else
                                    <small id="emailHelp" class="form-text text-muted">upload file JPG, JPEG, PNG, atau WEBP maksimal 15 MB jika ingin mengubah file sebelumnya</small>
                                @enderror
                            </div>
                          </div>
                    </div>
                </div>
                <a href="{{ route('peserta.daftar') }}" class="btn btn-default float-right">Batal</a>
                <button type="submit" class="btn btn-success">Simpan</button>
                <button type="button" class="btn btn-danger" data-toggle="modal" data-target="#modal-default">Batalkan Pengajuan  PKL</button>
            </form>
        </div>
    </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title">Batalkan Pengajuan PKL?</h4>
                ...
                <div class="modal-footer justify-content-between">
                    ...
                    <a href="{{ route('peserta.hapus') }}" class="btn btn-primary">Ya</a>
                </div>
            </div>
        </div>
    </div>
