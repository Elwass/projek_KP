        ...
        <div class="card-body">
            <div class="row">
                <div class="col-md-4 text-center mb-4">
                    ...
                    <img src="{{ $user->foto ? route('file.user', [$user->id, 'foto']) . '?v=' . optional($user->updated_at)->timestamp : asset('assets/img/avatar5.png') }}" alt="Foto profil {{ $user->name }}" class="img-fluid rounded border mb-3" style="max-height: 220px; object-fit: cover;">
                </div>
