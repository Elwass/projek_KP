            ...
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <p>
                            <img src="{{ $pendaftar->foto ? route('file.user', [$pendaftar->user_id, 'foto']) . '?v=' . optional($pendaftar->user_updated_at)->timestamp : asset('assets/img/default-foto-profile.jpg') }}" alt="Foto profil {{ $pendaftar->name }}" class="img-fluid rounded border" style="width: 150px; height: 150px; object-fit: cover;">
                        </p>
                    </div>
                </div>
            </div>
